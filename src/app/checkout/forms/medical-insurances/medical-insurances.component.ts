...
export class MedicalInsurancesComponent implements OnInit {
    MedicalInsurance: UntypedFormGroup;
    constructor( @Inject(MAT_DIALOG_DATA) public data: any, private _formBuilder: UntypedFormBuilder, private dialogRef: MatDialogRef<MedicalInsurancesComponent>) { }
    isAvailable:boolean;
    ngOnInit(): void {
        //updateParticipant();
