    ...
    constructor(@Inject(MAT_DIALOG_DATA) public data: any, private mapsAPILoader: MapsAPILoader,
        private ngZone: NgZone, private dataservice: DataService, private _formBuilder: UntypedFormBuilder, private dialogRef: MatDialogRef < KidDoctorComponent > ) {}
