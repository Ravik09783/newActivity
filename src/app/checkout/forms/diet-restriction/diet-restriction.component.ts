...
export class DietRestrictionComponent implements OnInit {
    DietRestriction: UntypedFormGroup;
    constructor( @Inject(MAT_DIALOG_DATA) public data: any, private _formBuilder: UntypedFormBuilder, private dialogRef: MatDialogRef<DietRestrictionComponent>) { }
