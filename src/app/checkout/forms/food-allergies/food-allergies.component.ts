...
export class FoodAllergiesComponent implements OnInit {
    FoodAllergy: UntypedFormGroup;
    constructor( @Inject(MAT_DIALOG_DATA) public data: any, private _formBuilder: UntypedFormBuilder, private dialogRef: MatDialogRef<FoodAllergiesComponent>) { }
