...
export class SymptomsFormComponent implements OnInit {
    Symptoms: UntypedFormGroup;
    constructor( @Inject(MAT_DIALOG_DATA) public data: any, private _formBuilder: UntypedFormBuilder, private dialogRef: MatDialogRef<SymptomsFormComponent>) { }
