...
export class EnvironmentAllergiesComponent implements OnInit {
    EnvironmentAllergy: UntypedFormGroup;
    constructor( @Inject(MAT_DIALOG_DATA) public data: any, private _formBuilder: UntypedFormBuilder, private dialogRef: MatDialogRef<EnvironmentAllergiesComponent>) { }
