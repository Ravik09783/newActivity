...
export class MedicationAllergiesComponent implements OnInit {
    medicationEllergies: UntypedFormGroup;
    constructor( @Inject(MAT_DIALOG_DATA) public data: any, private _formBuilder: UntypedFormBuilder, private dialogRef: MatDialogRef<MedicationAllergiesComponent>) { }
    isNoneSected:any;
