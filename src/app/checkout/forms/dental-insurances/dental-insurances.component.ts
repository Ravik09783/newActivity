...
export class DentalInsurancesComponent implements OnInit {
    DentalInsurances: UntypedFormGroup;
    constructor( @Inject(MAT_DIALOG_DATA) public data: any, private _formBuilder: UntypedFormBuilder, private dialogRef: MatDialogRef<DentalInsurancesComponent>) { }
    isAvailable:boolean;
    ngOnInit(): void {
        //updateParticipant();
