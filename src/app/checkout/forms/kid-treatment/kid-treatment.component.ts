...
export class KidTreatmentComponent implements OnInit {
    Treatment: UntypedFormGroup;
    constructor( @Inject(MAT_DIALOG_DATA) public data: any, private _formBuilder: UntypedFormBuilder, private dialogRef: MatDialogRef<KidTreatmentComponent>) { }
