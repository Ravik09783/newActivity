...
export class ApiRequestService {
  ...
  accessTokens = localStorage.getItem("accessToken")
  ...
  addParticipants(data){
    ...
    return this.http.post(`${this.baseUrl}v2/wp/kids`,data, this.headerss)
  ...
  getActivityinfo( params: string, _id:string){
    ...
    return this.http.get<any>(`${this.baseUrl}v2/wp/providers/${this.providerID}/${params}/${_id}/details`,this.header);
  }

  registerUser(data){
    return this.http.post(`${this.baseUrl}v2/wp/auth/email/registration`,data)

  }

  getParticipantsDatas(){
    // console.log("UUUUUUUUUUU", this.accessTokens)
    return this.http.get<any>(`${this.baseUrl}v2/wp/kids`, this.headerss)
  }
